			...
			//ZTest Always
				...
				float4 frag (v2f IN) : COLOR
				{
					...
					if (RampActive) {						
						...
						float2 uvRamp = float2(IN.uvBlink.x + _ScrollX, IN.uvBlink.y);
